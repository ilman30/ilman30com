  ...
  <div class="post-parallax parallax inverse-wrapper parallax1" style="background-image: url(style/images/art/par1.jpg);">
    <div class="container inner text-center">
      <div class="headline text-center">
        <h2>Ilman 30 Blog</h2>
        <p class="lead">Not Just a Blog</p>
      </div>
      <!-- /.headline --> 
    </div>
    <!--/.container --> 
...
<?php
  ...
  ?>           
            <div class="col-sm-6 col-md-4 grid-view-post">
              <div class="item post">
                <figure class="main"><a href="view_blog?page=view&judul=<?php echo $judul; ?>"><img src="img/blog/<?php echo $gambar; ?>" alt="" /></a></figure>
                <div class="box text-center">
                  <div class="category cat6"><span><a href="view_blog?page=view&judul=<?php echo $judul; ?>">Blog</a></span></div>
        ...
        <div class="pagination">
          <ul>
            ...
            <?php 
                for($x=1; $x<=$halaman; $x++) {
            ?>
            <li class="active"><a href="blog?page=<?php echo $x;?>"><span><?php echo $x;?></span></a></li>
            <?php
              }
            ?>
            <li><a href="#">Next</a></li>
