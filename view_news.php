        ...
        <div class="blog-content">
          <div class="blog-posts classic-view">
            <div class="post">
              ...
              <?php
              $query = mysql_query("SELECT * FROM berbayern WHERE judul = '$_GET[judul]'");
              $data = mysql_fetch_array($query);
              ?>          
              <title><?php echo $data['judul']; ?></title>
                <div class="category cat9"><span><a href="news">News</a></span></div>
                <h1 class="post-title"><?php echo $data['judul']; ?></h1>
                <div class="meta"><span class="date"><?php echo $data['tgl']; ?></span></div>
                <figure class="main"><img src="img/berbayern/<?php echo $data['gambar']; ?>" alt="" /></figure>
