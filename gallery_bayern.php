  ...
  <div class="post-parallax parallax inverse-wrapper parallax2" style="background-image: url(style/images/art/par1.jpg);">
    <div class="container inner text-center">
      <div class="headline text-center">
        <h2>Bayernzone Gallery</h2>
        <p class="lead">All pictures from bayernzone.</p>
      </div>
      <!-- /.headline --> 
    </div>
  </div>
...
<?php
  ...
  ?>  
          <div class="cbp-item"> <a class="cbp-caption fancybox-media" data-rel="portfolio" href="img/berbayern/<?php echo $gambar; ?>">
        ...
        <div class="pagination">
          <ul>
            ...
            <?php 
                for($x=1; $x<=$halaman; $x++) {
            ?>
            <li class="active"><a href="gallery_bayern?page=<?php echo $x;?>"><span><?php echo $x;?></span></a></li>
            <?php
              }
            ?>
            <li><a href="">Next</a></li>
